...
export default {
  setup() {
    ...
    const userCreateFunc = () => {
      if (
        userDataCreate.fullName.length > 3 &&
        userDataCreate.nationalCode.length > 9 &&
        userDataCreate.mobile_number.length > 10 &&
        userDataCreate.product_id.length > 3
      ) {
        store.dispatch("userCreate", userDataCreate);
        userDataCreate.fullName = "";
        userDataCreate.nationalCode = "";
        userDataCreate.mobile_number = "";
        userDataCreate.coupon_name = "";
